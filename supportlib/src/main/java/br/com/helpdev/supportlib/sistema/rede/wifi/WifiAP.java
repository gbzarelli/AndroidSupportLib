...
public class WifiAP {
    ...
    public static void conectarApAsync(final WifiManager wifiManager, final String ssid, final String pass) {
        new Thread() {
            @Override
            public void run() {
                try {
                    conectarAp(wifiManager, ssid, pass);
                } catch (Exception e) {
    ...
    public static void conectarAp(WifiManager wifiManager, final String ssid, final String pass) throws Exception {
...
//                    wc.allowedAuthAlgorithms.set(WifiConfiguration.AuthAlgorithm.SHARED);
    ...
    public static void desligarAP(WifiManager wifiManager) throws Exception {
        setWifiApEnable(wifiManager, null, false);
    }
}