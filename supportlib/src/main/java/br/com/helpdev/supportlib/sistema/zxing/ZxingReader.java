package br.com.helpdev.supportlib.sistema.zxing;
...
public class ZxingReader {
    public interface ZxingReaderCallback {
        public void resultZxing(boolean sucesso, String scanResult, String scanResultFormat);
    }
    ...
    public ZxingReader(Activity activity, Fragment frag, ZxingReaderCallback zxingReaderCallback) {
        this.activity = activity;
        this.fragment = frag;
        this.zxingReaderCallback = zxingReaderCallback;
    }

    public void setActivity(Activity activity, Fragment frag, ZxingReaderCallback zxingReaderCallback) {
        this.activity = activity;
        this.fragment = frag;
        this.zxingReaderCallback = zxingReaderCallback;
    }
    ...
    public void read(int idForResult, String type) {
        ...
        if (isPackageInstalled(PACKAGE)) {
            ...
            if (fragment == null && activity != null) {
                ...
                fragment.startActivityForResult(intent, idForResult);
            }
        } else {
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent intent) {
        if (requestCode == idForResult) {
            ...
            if (zxingReaderCallback != null) {
                zxingReaderCallback.resultZxing(resultCode == activity.RESULT_OK, scanResult, scanResultFormat);
            }
        }
    }
