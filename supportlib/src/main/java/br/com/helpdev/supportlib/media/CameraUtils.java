...
public class CameraUtils {
    ...
    private static final String[] EXTENSOES = new String[]{".jpeg", ".mp4"};
    ...
    public static File novaMidia(int tipo, String folderInMidia) {
        String nomeMidia = DateFormat.format("yyyy-MM-dd_hhmmss", new Date()).toString();
        File dirMidia = new File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DCIM), folderInMidia);
        if (!dirMidia.exists()) {
            dirMidia.mkdirs();
        }
    ...
    public static Bitmap rotacionar(Bitmap bitmap, String path) {
        try {
            ...
            Log.e("TAG", "rotacionar", e);
        }
        return bitmap;
    }

    public static Bitmap rotacionar(Bitmap source, float angle) {
