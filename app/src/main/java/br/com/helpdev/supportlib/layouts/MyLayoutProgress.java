package br.com.helpdev.supportlib.layouts;
...
public class MyLayoutProgress {
    ...
    public MyLayoutProgress(Activity activity, View fragmentView, int idContent) {
        this.viewProgress = fragmentView.findViewById(R.id.layout_progress);
        this.content = fragmentView.findViewById(idContent);
        load(activity);
    }

    public MyLayoutProgress(Activity activity, int idContent) {
    ...
    private void load(Activity activity) {
        ...
        bt1 = (Button) viewProgress.findViewById(R.id.progress_bt_1);
        bt2 = (Button) viewProgress.findViewById(R.id.progress_bt_2);
        tv1 = (TextView) viewProgress.findViewById(R.id.progress_tv_status);
        progress = (ProgressBar) viewProgress.findViewById(R.id.progress_bar);
    }
    ...
    public void showContentDelay(final int delay) {
        new Thread() {
            @Override
            public void run() {
                try {
    ...
    public void setBt1(int stringId, View.OnClickListener onClickListener) {
        setBt1(stringId, null, onClickListener);
    }

    public void setBt1(int stringId, Serializable tag, View.OnClickListener onClickListener) {
        this.setBt1(activity.getString(stringId), tag, onClickListener);
    }
    ...
    public void setBt2(int stringId, View.OnClickListener onClickListener) {
        setBt2(stringId, null, onClickListener);
    }

    public void setBt2(int stringId, Serializable tag, View.OnClickListener onClickListener) {
        this.setBt2(activity.getString(stringId), tag, onClickListener);
    }
